...
<head>
    ...
    <link rel="shortcut icon" href="picture/360.ico">
    <title>定时任务</title>
</head>
<body>
...
<script>
    ...
    $(document).ready(function () {
        $("#startTime").html("登录时间：" + insertTime.format("yyyy-MM-dd HH:mm:ss"))
        var time = 5;
        alert(time + "秒钟后启动定时任务")
    ...
    function print() {
        var date = new Date()
        $("#time").html("当前时间：" + date.format("yyyy-MM-dd HH:mm:ss") + "</br>");
